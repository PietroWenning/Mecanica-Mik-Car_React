...
<img src={img2} alt="Fundo" />
    ...
    <div id="btn-menu"><i class="bi bi-list"></i></div>

   
    <a href="https://api.whatsapp.com/message/EMJNJWWOLFOGJ1?autoload=1&app_absent=0" 
       target="_blank" class="btn-contato-link">
  ...
  <li className="icon-content">
    <a
      ...
      aria-label="Whatsapp"
      href="https://api.whatsapp.com/message/EMJNJWWOLFOGJ1?autoload=1&app_absent=0" target="_blank"
    >
  ...
  <li className="icon-content">
    <a
      ...
      aria-label="Facebook"
      href="https://www.facebook.com/p/Mikcar-Centro-Automotivo-100083865105719/?locale=pt_BR" target="_blank"
    >
      <div class="filled"></div>
      <svg
        xml:space="preserve"
